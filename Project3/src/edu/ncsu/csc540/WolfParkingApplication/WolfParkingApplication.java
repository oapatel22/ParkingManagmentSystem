...
public class WolfParkingApplication {
    ...
    public static void main(final String[] args) {
        ...
        enterPermitInfo("12", "commuter", "A", "Test", "dgoggins", "PROFX", "Handicap", "2023-01-01",
                "2023-11-15", "06:00:00");
        ...
        // System.out.println("2) Maintaining permits and vehicle information for each
        // driver");
    ...
    public static void enterPermitInfo(final String permitID, final String permitType, final String zoneID,
        ...
        if (currStatus.equals("V")) {
            ...
            if(!spaceType.equals("AS") || !spaceType.equals("BS") || !spaceType.equals("CS") ||!spaceType.equals("DS")) {
                canExecute = false;
     ...
     *
     * @param LotName
     *                   the name of the parking lot where the vehicle relevant to
     *                   the
     *                   citation exists
     * @param LicenseNum
